...
import logoSm from "../../assets/images/netbuddy1.png";
import logoDark from "../../assets/images/netbuddy1.png";
import logoLight from "../../assets/images/netbuddy1.png";
...
const Header = () => {
  ...
  useEffect(()=>{
    ...
    document.body.setAttribute("class","right-bar-enabled");
            ...
            <div>
              <div className="navbar-brand-box">
                ...
                <Link to="/" className="logo logo-light">
                  ...
                  <span className="logo-lg">
                  <p style={{margin:0}}><img src={logoLight} alt="" height="35" style={{marginTop:"-12px"}}/> &nbsp;<span style={{color:"#ffffff",fontSize:"31px", marginTop:"21px"}}>Net</span><span style={{color:"#ffffff",fontSize:"31px", marginTop:"22px", fontWeight:"bold"}}>Ex</span></p>
                  </span>
                </Link>
              </div>
              <button
